        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-header">
              <form action="/keluar/tambah" method="post" enctype="multipart/form-data">
                <h2>Tambah data</h2>
                <div class="row">
                  <div class="col-md">
              ...
              <div class="row">
                <div class="col-md">
                  ...
                  <a href="/keluar/excel" class="btn btn-outline-success shadow float-right">Excel <i class="fa fa-file-excel"></i></a>
                </div>
              </div>
                ...
                <div class="col-md">
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php if (!empty($keluar->getResultArray())) :   ?>
                          <?php $i = 1;  ?>
                          <?php foreach ($keluar->getResultArray() as $row) : ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="/keluar/hapus/<?= $row['no_surat']; ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i> </a>
                              </td>
                            </tr>
                            <?php $i++; ?>
                          <?php endforeach; ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?= base_url('keluar/ubah'); ?>" method="post" enctype="multipart/form-data">
