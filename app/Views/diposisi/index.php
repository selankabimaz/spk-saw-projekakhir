        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <form action="/diposisi/tambah" method="post" enctype="multipart/form-data">
                <h2>Tambah data</h2>
                <div class="row">
                  <div class="col-md">
                    <div class="form-group">
                      <label for="nama_agenda"></label>
                      <input type="int" name="nama_agenda" id="nama_agenda" class="form-control" placeholder="Nama Agenda">
                    </div>
                    <div class="form-group">
                      <label for="tgl_surat"></label>
                      <input type="date" name="tgl_surat" id="tgl_surat" class="form-control" placeholder="Tgl Diterima">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <input type="int" name="no_surat" id="no_surat" class="form-control" placeholder="No Surat">
                    </div>
                    <div class="form-group">
              ...
              <div class="row">
                <div class="col-md">
                  ...
                  <a href="/diposisi/excel" class="btn btn-outline-success shadow float-right">Excel <i class="fa fa-file-excel"></i></a>
                </div>
              </div>
                ...
                <div class="col-md">
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php if (!empty($diposisi->getResultArray())) :   ?>
                          <?php $i = 1;  ?>
                          <?php foreach ($diposisi->getResultArray() as $row) : ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="/diposisi/hapus/<?= $row['no_surat']; ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i> </a>
                              </td>
                            </tr>
                            <?php $i++; ?>
                          <?php endforeach; ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?= base_url('diposisi/ubah'); ?>" method="post" enctype="multipart/form-data">
                  <div class="form-group mb-0">
                    <label for="nama_agenda"></label>
                    <input type="text" name="nama_agenda" id="nama_agenda" class="form-control" placeholder="Masukkan Nama Agenda">
                  </div>
                  <div class="form-group mb-0">
                    <label for="no_surat"></label>
                  ...
                  <div class="form-group mb-0">
                    <label for="tgl_surat"></label>
                    <input type="date" name="tgl_surat" id="tgl_surat" class="form-control" placeholder="">
                  </div>
                  <div class="form-group mb-0">
                    <label for="perihal"></label>
